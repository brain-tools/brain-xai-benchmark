...
class Model(LightningModule):
    def __init__(self, model_depth=121,
        ...
        # generate model
        self.model = generate_model(model_depth=model_depth, n_input_channels=1, num_classes=1)
        ...
        self.expl_computer = ExplComputer(model_type="DenseNet", train_mean=self.train_mean, train_std=self.train_std, deep_lift_mean_img=self.mean_img)
